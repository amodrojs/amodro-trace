...
(function() {
  ...
  function defaultRead(id, filePath, encoding) {
  ...
  requirejs.s.newContext = function (name) {
    ...
    context._setToolOptions = function(options) {
      ...
      var rootRead = defaultRead;
      var optionRead = options.fileRead;
      if (optionRead) {
        rootRead = function(id, filePath, encoding) {
          return optionRead(defaultRead, id, filePath, encoding);
        };
      }
      ...
      context.fileRead = function (id, filePath, encoding) {
        if (lang.hasProp(context._cachedRawText, filePath)) {
          ...
          if (context.fileExists(id, filePath)) {
            var text = rootRead(id, filePath, encoding);
            context._cachedRawText[filePath] = text;
            return text;
          } else {
            throw new Error('File not found: ' + filePath + ' for id: ' + id);
          }
        }
      }
    };
