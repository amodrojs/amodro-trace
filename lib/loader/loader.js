...
(function() {
                ...
                if (falseProp(context.needFullExec, moduleName)) {
                  contents = parse(moduleName, url, contents, {
                    ...
                    findNestedDependencies:
                                           context.config.findNestedDependencies
                  });
                }
              } catch (e2) {
                throw new Error('Parse error using esprima ' +
  ...
  require._readFile = function(filePath, encoding) {
    return fs.readFileSync(filePath, encoding || 'utf8');
  };

  require._fileExists = function (filePath) {
  ...
  var loader = {
    ...
    create: function(id) {
      ...
      var loader = requirejs.config({ context: id });
    ...
    discard: function(id) {
      var contextName = loader.config.contextName;
